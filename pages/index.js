...
export default function Home() {
  ...
  return (
      <>
          <HeadSeo currentURL={router.asPath} pageTitle={'TOURNONS LA PAGE CAMEROUN | ACCEUIL'} description={'Nous sommes un mouvement citoyen international qui agit pour la promotion de l’alternance démocratique en Afrique subsaharienne.'} previewImage={'/2e_assemblee_generale_ordinaire/IMG_2CE9185DEAF3-1.jpeg'}/>
          <Slider/>
          <ActualitiesSlider/>
          <section className="sm:p-20 p-7">
            <div className='flex lg:bg-default w-full flex-wrap sm:justify-between lg:justify-center items-center lg:py-20'>
                ...
                <img src="/afrique-cartee.png" className='sm:mt-0 sm:w-3/6 mt-10 lg:w-3/6 xl:w-2/6 h-full object-cover z-0' alt="carte"/>
            </div>
          </section>
          <HeaderAbout/> 
          <VideosSlider/>
          <div className='w-full flex flex-col justify-center items-center pt-10 lg:pt-20 pb-10 sm:py-20 lg:py-0 lg:pb-32'>
                <h1 className="text-orange-500 text-center text-xl sm:text-2xl pb-10 lg:mb-10 font-thin lg:text-3xl px-7 lg:p-10 lg:px-20 uppercase w-5/6 sm:w-4/6 xl:w-3/6">Ensemble pour la libération de nos camarades</h1>
                ...
                <Link href="/camarades_detenus"><button className="mt-10 sm:mt-16 border-0.5 border-orange-500 bg-orange-500 text-xs lg:text-sm flex lg:mt-20 items-center px-5 py-1 sm:px-12 sm:py-4 text-white font-light uppercase sm:ml-0  button-video hover:lg:border-orange-300 hover:lg:text-orange-500 hover:lg:bg-transparent ease-in duration-100">Camarades déténus <FiArrowRight className='pl-3 text-3xl'/></button></Link>
          </div>
