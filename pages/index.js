  ...
  return (
      <>
          ...
          <div className="bg-gray-100 w-full py-36 flex flex-col items-center sm:px-20 px-7">
              <h1 className='font-bold text-4xl text-center text-gray-800 carte-text carte-text-after'>Mouvement Tournons La Page</h1>
          ...
          <div className="w-full py-36 flex flex-col items-center sm:px-20 px-7">
              <h1 className='font-bold text-4xl text-center text-gray-800 carte-text carte-text-after'>Partenaires internationaux</h1>
