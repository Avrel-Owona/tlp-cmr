		...
		<section className="lg:pt-28 pb-10 lg:py-28 bg-gray-100 lg:bg-white">
			<div>
				<div className="hidden lg:flex items-center sm:justify-between px-7 lg:px-20 justify-center xl:pl-36 flex-wrap">
					<h1 className="text-3xl uppercase font-thin text-orange-500">
						Actualités
					</h1>
					<Link href="/actualites">
						<button className="text-orange-400 lg:text-white border-0.5 ease-in duration-100 border-orange-500 lg:bg-orange-500 text-sm sm:text-base hidden sm:flex sm:mt-0 items-center px-12 py-3 font-thin  hover:lg:bg-transparent hover:lg:text-orange-500 hover:lg:border-orange-500">
							Toutes les actualités <FiArrowRight className="pl-3 text-3xl" />
						</button>
					</Link>
				</div>
			</div>
			...
			>
				...
				<Link href="/actualites">
					<button className="text-orange-500 lg:hidden border-0.5 w-max mt-10 sm:mt-20 font-extralight sm:font-light border-orange-400 text-sm sm:text-base flex items-center px-5 py-2 sm:px-12 sm:py-4">
						...
						<FiArrowRight className="pl-3 text-2xl sm:text-3xl" />
					</button>
				</Link>
			</Swiper>
		</section>
