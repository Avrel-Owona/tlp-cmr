        ...
        <div className="header lg:px-20 px-4 w-full relative flex justify-center">
            <div className="flex justify-center flex-wrap-reverse sm:pt-20 lg:pb-20 w-full xl:w-11/12">
                <div className="w-full lg:shadow-lg xl:h-full justify-center pb-10 xl:pb-0 pr-10 lg:px-10 lg:w-96 bg-white lg:relative flex flex-col lg:items-center">
                    ...
                    <p className="flex flex-wrap items-center text-base font-light justify-start lg:justify-center xl:justify-start pt-8 xl:pt-0 lg:font-normal text-gray-900">
                        Crée le  <span className="text-orange-500 ml-1 font-normal"> 14 Septembre 2015</span>
                    </p>
                    <p className="font-light text-base text-gray-700 mt-6 lg:text-center sm:w-4/6 lg:w-full">Nous sommes un mouvement citoyen international qui agit pour la promotion de l’alternance démocratique en Afrique subsaharienne.</p>
                    <Link href="/actualites"><button className="mt-10 border-0.5 w-max border-orange-400 text-base flex items-center px-5 py-2 sm:px-12 sm:py-4 text-orange-500 font-extralight ease-in duration-100 hover:text-white hover:bg-orange-500 hover:border-orange-500">Nos ressources <IoMdDocument className="ml-2 text-sm lg:text-base"/></button></Link>
                </div>
